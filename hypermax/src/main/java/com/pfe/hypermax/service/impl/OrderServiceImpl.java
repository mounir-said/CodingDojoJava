...
import com.pfe.hypermax.model.OrderAddress;
import com.pfe.hypermax.model.OrderRequest;
import com.pfe.hypermax.model.ProductOrder;
import com.pfe.hypermax.repository.CartRepository;
import com.pfe.hypermax.repository.ProductOrderRepository;
...
public class OrderServiceImpl implements OrderService {
	...
	public void saveOrder(Integer userid, OrderRequest orderRequest) throws Exception {
		...
		for (Cart cart : carts) {
			...
			address.setUserName(orderRequest.getFirstName());
			address.setUserName(orderRequest.getLastName());
